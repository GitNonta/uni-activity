...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // ── สร้างผู้ใช้: เจ้าหน้าที่ 1 คน + นักศึกษา 10 คน ──
        $admin = User::create([
        ...
        for ($i = 0; $i < 10; $i++) {
            $students->push(User::create([
                'student_id' => '65' . str_pad($i + 1, 8, '0', STR_PAD_LEFT),
                'full_name'  => $names[$i],
        ...
        // ── สร้างหมวดหมู่กิจกรรม 5 หมวด พร้อมชั่วโมงขั้นต่ำ ──
        $categories = collect([
        ...
        // ── สร้างการลงทะเบียน: สุ่มนักศึกษา 3-8 คนต่อกิจกรรม ──
        foreach ($activities as $activity) {
            $registeredStudents = $students->random(rand(3, 8));
        ...
        // ── สร้างการเข้าร่วมสำหรับ 2 กิจกรรมแรก (จำลองกิจกรรมที่เสร็จแล้ว) ──
        ...
        $this->command->info('Seeded: 11 users (1 staff + 10 students), 5 categories, 8 activities, registrations & attendances');
    }
}
