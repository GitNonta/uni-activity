...
class LineController extends Controller
{
    ...
    public function callback(Request $request): RedirectResponse
    {
        ...
        $messageText = "🎉 ยินดีต้อนรับสู่ UNI Activity\n\n"
            . "สวัสดี {$displayName} 👋\n\n"
            . "✅ เชื่อมต่อบัญชีสำเร็จแล้ว\n\n"
            . "บัญชีนักศึกษา\n"
            . "👤 {$fullName}\n"
            . "🎓 รหัสนักศึกษา: {$studentId}\n\n"
            . "ขณะนี้บัญชีของคุณได้ ผูกกับ LINE สำเร็จเรียบร้อยแล้ว 🎊\n\n"
            . "---\n\n"
            . "📢 ไม่พลาดทุกความเคลื่อนไหว\n\n"
            . "จากนี้คุณจะได้รับการแจ้งเตือนผ่าน LINE ทันที เมื่อมี\n\n"
            . "📅 กิจกรรมใหม่\n"
            . "📣 ประกาศสำคัญ\n"
            . "📰 ข่าวสารจากมหาวิทยาลัย\n"
            . "⏰ แจ้งเตือนก่อนเริ่มกิจกรรม\n"
            . "🏆 อัปเดตสถานะการเข้าร่วมและชั่วโมงกิจกรรม\n\n"
            . "ขอบคุณที่ร่วมเป็นส่วนหนึ่งของ UNI Activity 💙\n\n"
            . "\"ทุกกิจกรรมสำคัญ เราจะแจ้งให้คุณทราบก่อนใคร\"";
