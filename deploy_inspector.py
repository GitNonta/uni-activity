...
sftp.put(r'd:\projects\uni-activity\monitor_server.py', f'{APP_DIR}/monitor_server.py')
...
client.exec_command(f'nohup python {APP_DIR}/monitor_server.py </dev/null > {APP_DIR}/monitor.log 2>&1 &')
