...
print("--- 2. Downloading 1 Placeholder Image and copying ---")
run_cmd(f"curl -sL https://picsum.photos/800/600 -o {APP_DIR}/storage/app/public/activities/base.jpg")
run_cmd(f"ls -l {APP_DIR}/storage/app/public/activities/base.jpg")

for i in range(1, 11):
    run_cmd(f"cp {APP_DIR}/storage/app/public/activities/base.jpg {APP_DIR}/storage/app/public/activities/activity_{i}.jpg")
...
for ($i = 1; $i <= 10; $i++) {
    ...
    App\\Models\\Activity::create([
        'title' => 'กิจกรรมทดสอบที่ ' . $i,
        'description' => 'รายละเอียดของกิจกรรมทดสอบ',
