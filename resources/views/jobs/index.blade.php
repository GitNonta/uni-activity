...
function buildMarkers() {
    ...
    geoJobs.forEach(function(j) {
        ...
        marker.bindPopup(
            ...
            + '<div class="map-popup-meta">💼 ' + escHtml(j.position) + '</div>'
            + '<div class="map-popup-meta">📍 ' + escHtml(j.location) + '</div>'
            + (j.compensation ? '<div class="map-popup-meta">💰 ' + escHtml(j.compensation) + '</div>' : '')
            + dist + dirBtn + navBtn
