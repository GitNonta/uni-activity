...
<div class="space-y-3">
    ...
    <a href="{{ route('announcements.show', $item) }}" class="card mb-3 block no-linkify" style="text-decoration:none;">
                    ...
                    <div class="flex gap-3">
                        <div style="flex:1;">
                            <div class="flex justify-between items-start mb-1">
                                <h3 class="font-semi text-sm" style="color:var(--text-main, #1e293b);" title="{{ $item->title }}">{{ Str::limit($item->title, 45, '...') }}</h3>
