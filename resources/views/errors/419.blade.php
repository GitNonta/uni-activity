...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .countdown { color: var(--orange); font-weight: 700; font-variant-numeric: tabular-nums; }
        .theme-toggle {
...
<body>
    ...
    <div class="card">
        ...
        <p class="desc">
            เซสชันของคุณหมดอายุเนื่องจากไม่มีการใช้งานเป็นระยะเวลาหนึ่ง
            กรุณารีเฟรชหน้าเว็บหรือเข้าสู่ระบบใหม่อีกครั้ง
        </p>
        <div class="actions">
        ...
        <hr class="divider">
        <p class="footer">
            ระบบจะนำคุณไปยังหน้าเข้าสู่ระบบอัตโนมัติใน <span class="countdown" id="countdown">5</span> วินาที
        </p>
    </div>
