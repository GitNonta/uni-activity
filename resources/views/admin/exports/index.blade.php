    ...
    <div class="card" style="grid-column:1/-1;">
        <div class="card-header">
            <h3 class="card-title">
                ...
                รายชื่อนักศึกษา
                <span id="field-count-badge" style="background:#c2410c;color:#fff;border-radius:999px;padding:2px 10px;font-size:.75rem;margin-left:8px;font-weight:600;line-height:1.5;">11 fields</span>
            </h3>
        </div>
        <div class="card-body">
