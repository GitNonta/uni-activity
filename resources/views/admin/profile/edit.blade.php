            ...
            <div style="display: flex; align-items: center; gap: 1.25rem; flex-wrap: wrap;">
                ...
                <div style="position: relative; width: 88px; height: 88px; flex-shrink: 0;">
                    ...
                    <form id="profilePhotoForm" method="POST" action="{{ route('profile.photo.upload') }}" enctype="multipart/form-data" style="display: none;">
                        @csrf
                        <input type="file" id="profilePhotoInput" name="profile_photo" accept="image/jpeg,image/png,image/webp" onchange="if (window.startFaceStatusPolling) { window.startFaceStatusPolling(); } document.getElementById('profilePhotoForm').submit();">
                    </form>
                </div>
