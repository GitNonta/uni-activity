                ...
                <tr>
                    <td colspan="7">
                        <div class="empty-state-row">
                            ...
                            <div class="empty-state-row-title">ยังไม่มีผู้สมัคร</div>
                            <div class="empty-state-row-desc">ผู้สมัครงานจะปรากฏที่นี่เมื่อมีนักศึกษาสมัครงานนี้</div>
                        </div>
                    </td>
                </tr>
                @endforelse
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="empty-state empty-state-sm">
            ...
            <p class="empty-state-title">ยังไม่มีคอมเมนต์</p>
            <p class="empty-state-desc">คอมเมนต์จากนักศึกษาจะปรากฏที่นี่</p>
        </div>
        @endforelse
    </div>
</div>
