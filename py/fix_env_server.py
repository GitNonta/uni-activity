...
print(run_cmd("sed -i 's/DB_USERNAME=admin/DB_USERNAME=postgres/g' /data/data/com.termux/files/home/uni-activity/.env"))
print(run_cmd("sed -i 's/DB_PASSWORD=Admin234/DB_PASSWORD=/g' /data/data/com.termux/files/home/uni-activity/.env"))
