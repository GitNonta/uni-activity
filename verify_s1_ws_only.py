#!/usr/bin/env python3
"""WS-broadcast-only check against running S1 monitor (no restart)."""
...
cmd = "python3 - << 'PYEOF'" + NL + NL.join(L) + NL + "PYEOF"
_, o, e = ssh.exec_command(cmd, timeout=150)
